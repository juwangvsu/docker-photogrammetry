...
# 
# config file updated using manage script on Sun Feb  9 20:53:45 2020
############################################################
...
$dataurl = 'http://172.17.0.2/photodata';
...
$admin_email = 'jwang3vsu@gmail.com';
